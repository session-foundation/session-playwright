...
import { sendImage } from './utilities/send_media';
...
test_Alice_1W_Bob_1W(
  'Send disappearing image 1:1',
  async ({ alice, aliceWindow1, bob, bobWindow1 }) => {
    const testMessage = `${alice.userName} sending disappearing image to ${bob.userName}`;
    ...
    // Send image
    await sendImage(aliceWindow1, testMessage);
